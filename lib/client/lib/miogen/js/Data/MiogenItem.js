Miogen.require(['Data.MiogenDataField'], function () {
    Miogen.define('Data.MiogenItem', Class.extend({
        ...
        construct: function (itemData, template) {
        ...
        getUri: function () {
            return this.itemData.item.href;
        },
        
        get: function (attributeQuery, /* optional */ defaultValue) {
            return Miogen.queryObject(this.itemData.item.data, attributeQuery, defaultValue);
        },
        ...
        set: function (attributeQuery, value) {
            ...
            if (currentValue !== value) {
                ...
                Miogen.setObjectValue(this.itemData.item.data, attributeQuery, value);
